...
This note summarizes the end-to-end sequence each time an event hits OmniDaemon’s agent runner.  It also calls out how the supervisor prepares Python, Go, and TypeScript agents (dependencies, build steps, adapters, etc.) before launching them.
